/// _code_find.dart — Search engine implementation for find/replace.
///
/// [_CodeFindControllerImpl] runs regex-based text search in an isolate
/// via [_IsolateTasker] so large files don't block the UI. It manages the
/// find and replace input controllers, match navigation (next/previous),
/// single and bulk replacement, and the [CodeFindValue] state that drives
/// the find overlay UI.
part of editor;
