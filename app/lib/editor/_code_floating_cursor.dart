/// _code_floating_cursor.dart — iOS floating cursor support.
///
/// [_CodeFloatingCursorController] tracks the translucent "floating" cursor
/// that appears when the user long-presses the spacebar on iOS. It manages
/// the floating cursor offset, the grey preview cursor, and the snap-back
/// animation that returns the cursor to its final position when released.
part of editor;
