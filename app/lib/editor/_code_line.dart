/// _code_line.dart — Internal implementation of [CodeLineEditingController].
///
/// [_CodeLineEditingControllerImpl] is the workhorse behind the public
/// controller API. It manages the undo/redo stack, selection state,
/// code manipulation methods (insert, delete, indent, fold), clipboard
/// integration, and the editing value change notifications. Also contains
/// [_CodeLineEditingCache] for caching derived layout data.
part of editor;
