/// code_shortcuts.dart — Keyboard shortcut types and default key bindings.
///
/// Defines [CodeShortcutType] (all supported editor shortcuts),
/// [CodeShortcutsActivatorsBuilder] (abstract binding builder),
/// [DefaultCodeShortcutsActivatorsBuilder] (platform-aware defaults),
/// and the corresponding [Intent] subclasses dispatched by the shortcut
/// system.

part of editor;

/// Enumerates every keyboard shortcut the editor can handle.
///
/// Each value maps to one or more [ShortcutActivator]s via
/// [CodeShortcutsActivatorsBuilder.build] and to an [Intent] via
/// [kCodeShortcutIntents].
...
/// Abstract builder that maps each [CodeShortcutType] to its keyboard
/// activators. Override [build] to customize key bindings.
...
/// Default key binding builder that returns macOS bindings on macOS and
/// common (Windows/Linux) bindings on other desktop platforms.
