/// _code_input.dart — Platform IME / soft-keyboard integration.
///
/// [_CodeInputController] implements [DeltaTextInputClient] to bridge the
/// platform text input system with the editor's data model. It translates
/// IME composing regions, insertion/deletion deltas, and autocomplete
/// symbol pairs into [CodeLineEditingController] operations. Also manages
/// the floating cursor scroll timer on mobile.
part of editor;
