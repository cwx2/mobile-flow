/// _code_paragraph.dart — Concrete implementation of [IParagraph] using TextPainter.
///
/// [_ParagraphImpl] wraps a [ui.Paragraph] to provide text layout, offset
/// lookup, and drawing for a single code line. It caches position-to-offset
/// mappings for performance and handles edge cases like zero-width joiners,
/// truncated long lines, and multi-line word-wrap layout.
part of editor;
