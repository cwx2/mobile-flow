/// code_editor.dart — Main CodeEditor widget and visual style configuration.

part of editor;

/// An immutable style describing how to format and paint editor content.
///
/// Controls font, colors, cursor appearance, and syntax highlighting theme
/// for a [CodeEditor] instance. All properties are optional and fall back
/// to sensible defaults derived from the ambient Flutter theme.
