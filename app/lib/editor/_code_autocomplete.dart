/// _code_autocomplete.dart — Autocomplete prompt matching and overlay positioning.
///
/// [_DefaultCodeAutocompletePromptsBuilder] collects keyword, direct, and
/// related prompts from the language mode and filters them against the
/// current word prefix. [_CodeAutocomplete] is the overlay widget that
/// positions the autocomplete popup relative to the cursor and handles
/// item selection, keyboard navigation, and dismissal.
part of editor;
