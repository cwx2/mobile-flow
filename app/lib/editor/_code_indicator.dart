/// _code_indicator.dart — Custom RenderObjects for the editor gutter.
///
/// [CodeLineNumberRenderObject] paints line numbers in the left gutter,
/// highlighting the focused line with a distinct style. It listens to the
/// editing controller and repaints when the line count or selection changes.
///
/// [CodeChunkIndicatorRenderObject] draws fold/unfold arrows next to
/// collapsible code chunks, responding to tap gestures to toggle folding.
part of editor;
