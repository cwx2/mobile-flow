/// code_autocomplete.dart — Autocomplete prompt API and overlay widget.
///
/// Provides [CodeAutocomplete] (the overlay widget), [CodePrompt] (abstract
/// prompt base), [CodeKeywordPrompt], [CodeFieldPrompt], [CodeFunctionPrompt]
/// (concrete prompt types), and [DefaultCodeAutocompletePromptsBuilder]
/// (default matching logic).

part of editor;

/// Abstract base for a single autocomplete suggestion.
///
