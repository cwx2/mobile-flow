/// _code_scroll.dart — Custom scrollable with dual-axis support.
///
/// [_CodeScrollable] wraps Flutter's [Scrollable] with a custom
/// [_ScrollBehavior] that provides clamping physics and optional
/// scrollbar builders for both vertical and horizontal axes. Supports
/// the virtual viewport used by [_CodeFieldRender] to only lay out
/// visible lines, and integrates with [CodeScrollController] for
/// programmatic scroll-to-line.
part of editor;
