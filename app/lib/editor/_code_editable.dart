/// _code_editable.dart — Stateful bridge between the editing controller and the render layer.
///
/// [_CodeEditable] is a StatefulWidget that wires up the
/// [CodeLineEditingController], animation controllers (cursor blink,
/// floating cursor snap-back), focus management, and the code field's
/// render object. It rebuilds the render tree when the editing value,
/// theme, or focus state changes.
part of editor;
