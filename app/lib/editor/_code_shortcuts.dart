/// _code_shortcuts.dart — Keyboard shortcut mapping and dispatch.
///
/// [_CodeShortcuts] is a StatefulWidget that builds a [Shortcuts] widget
/// from the [CodeShortcutsActivatorsBuilder], mapping platform key
/// combinations to [CodeShortcutType] intents. [_CodeShortcutActions]
/// listens for those intents and dispatches them to the corresponding
/// editing operations on the controller (e.g. copy, paste, undo, indent).
part of editor;
