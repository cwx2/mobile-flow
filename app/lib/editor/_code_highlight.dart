/// _code_highlight.dart — Background syntax highlighting via isolate.
///
/// [_CodeHighlighter] manages the syntax highlighting pipeline: it sends
/// the current code text and language mode to [_CodeHighlightEngine] running
/// in an isolate, caches the resulting [_HighlightResult] list, and rebuilds
/// [IParagraph] instances with highlighted [TextSpan]s when the code or
/// theme changes. Uses [_IsolateTasker] to keep highlighting off the UI thread.
part of editor;
