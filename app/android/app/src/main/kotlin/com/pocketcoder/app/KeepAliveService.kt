 ...
 *
 * Notification states:
 *   - Connected (idle):  "Pocket Coder · 已连接"
...
class KeepAliveService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "pocket_coder_keepalive"
        const val NOTIFICATION_ID = 1001

        const val ACTION_UPDATE = "com.pocketcoder.app.UPDATE_NOTIFICATION"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val title = intent?.getStringExtra(EXTRA_TITLE) ?: "Pocket Coder"
